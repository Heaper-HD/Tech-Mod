    ...
    public static void Initialize() {
        DefaultItemComponentEvents.MODIFY.register(context -> {
            ...
            context.modify(Blocks.TERRACOTTA.asItem(), builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(
            ...
            context.modify(Blocks.STONE.asItem(), builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.SILICON_DIOXIDE, PurityLevel.IMPURE)));
            });
            ...
            context.modify(Blocks.COAL_BLOCK.asItem(), builder -> {
                builder.add(ModDataComponentsType.ELEMENTS_COMPONENT, List.of(
            ...
            context.modify(Items.CLAY_BALL, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.KAOLINITE, PurityLevel.IMPURE)));
            });
            context.modify(Items.BRICK, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.KAOLINITE, PurityLevel.IMPURE)));
            });
            context.modify(Items.COAL, builder -> {
                builder.add(ModDataComponentsType.ELEMENTS_COMPONENT, List.of(new ElementComponent(Elements.CARBON, PurityLevel.NORMAL)));
            });
            ...
            context.modify(Items.COPPER_INGOT, builder -> {
                builder.add(ModDataComponentsType.ELEMENTS_COMPONENT, List.of(new ElementComponent(Elements.COPPER, PurityLevel.NORMAL)));
            });
            ...
            context.modify(Items.IRON_INGOT, builder -> {
                builder.add(ModDataComponentsType.ELEMENTS_COMPONENT, List.of(new ElementComponent(Elements.IRON, PurityLevel.NORMAL)));
            });
            ...
            context.modify(Items.GOLD_INGOT, builder -> {
                builder.add(ModDataComponentsType.ELEMENTS_COMPONENT, List.of(new ElementComponent(Elements.GOLD, PurityLevel.NORMAL)));
            });
            context.modify(Items.GOLD_NUGGET, builder -> {
                builder.add(ModDataComponentsType.ELEMENTS_COMPONENT, List.of(new ElementComponent(Elements.GOLD, PurityLevel.NORMAL)));
            });
            context.modify(Items.LAPIS_LAZULI, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.LAPIS, PurityLevel.NORMAL)));
            });
            context.modify(Items.EMERALD, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.EMERALD, PurityLevel.NORMAL)));
            });
            context.modify(Items.DIAMOND, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.DIAMOND, PurityLevel.NORMAL)));
            });
            context.modify(Items.QUARTZ, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.SILICON_DIOXIDE, PurityLevel.NORMAL)));
            });
            ...
            context.modify(Items.ANCIENT_DEBRIS, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.ANCIENT_MATERIAL, PurityLevel.IMPURE)));
            });
            context.modify(Items.NETHERITE_INGOT, builder -> {
                builder.add(ModDataComponentsType.COMPOUNDS_COMPONENT, List.of(new CompoundComponent(Compounds.NETHERITE, PurityLevel.NORMAL)));
            });
        });
    }
}
